...
while(1)
{
    ...
    printf("\n\n\t\t\t3. Delete form");
    printf("\n\n\t\t\t4. ENTRANCE EXAMINATION");//MODIFY
    printf("\n\n\t\t\t5. DISPLAY STUDENT RECORD");//DISPLAY
    printf("\n\n\t\t\t6. Search Record");// RECORD
    printf("\n\n\t\t\t7. Sort result");
    printf("\n\n\t\t\t0. EXIT");
    printf("\n\t");
	printf("\n\t");
...
void exam(FILE *fp)
{
    ...
    printf("\t\t");
    printChar('~',85);
    puts("\n\t\t*points to remember while facing entrance");
    puts("\n\t\t* One should enter their identification document number to began the entrance exam.");
	puts("\n\t\t* Entrance is taken for 30 minute having total 10 marks.");
	puts("\n\t\t* Examinee can skip any question by pressing s.");	
	puts("\n\t\t* Once skipped questions cant be reattemped.");
	puts("\n\t\t* It consist of 10 question each having 1 marks.");
	puts("\n\t\t* There is the negative marking of 0.1 marks per each wrong answer.");
	puts("\n\t\t* Once the answer is submitted cannot be recorrected.");
	puts("\n\t\t* Total score is displayed when all the answer are submitted.");
	printf("\t\t");
	printChar('~',85);
	printf("\n\n\n");
	getch();
